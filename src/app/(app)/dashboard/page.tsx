...
const ContinueJourney = dynamic(() => import('@/components/app/dashboard/continue-journey-card'), {
  loading: () => (
    <div
          ...
          <Suspense
            fallback={
              <div className="flex flex-col gap-y-2 min-h-20">
                <LoadingSpinner />
                <p className="text-sm text-gray-400 font-light font-onest mt-3">Loading...</p>
              </div>
            }
          >
            <ContinueJourney />
