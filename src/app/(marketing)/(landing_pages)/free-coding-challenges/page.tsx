...
export default function FreeCodingChallengesPage() {
  const jsonLd: WebPageJsonLd = {
    ...
    description:
      'Master coding with TechBlitz’s free coding challenges. Learn JavaScript, web development, and programming through real-world challenges tailored to your skill level.',
    image:
    ...
    <>
      ...
      <div className="container">
        ...
        <MarketingContentGrid
          title="Everything You Need to Learn to Code for Free"
          items={items}
        />
