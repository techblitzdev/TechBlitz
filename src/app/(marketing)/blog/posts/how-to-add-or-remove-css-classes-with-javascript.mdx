...
<CodeSnippet language="javascript" content={`const button = document.querySelector('.action-button');
...
<CodeSnippet language="javascript" content={`const modal = document.querySelector('.modal');
...
<CodeSnippet language="javascript" content={`const menuButton = document.querySelector('.menu-toggle');
...
<CodeSnippet language="javascript" content={`const themeToggle = document.querySelector('.theme-toggle');
...
<CodeSnippet language="javascript" content={`const button = document.querySelector('.action-button'); // Reusable reference`} />
...
<CodeSnippet language="javascript" content={`// Bad practice
