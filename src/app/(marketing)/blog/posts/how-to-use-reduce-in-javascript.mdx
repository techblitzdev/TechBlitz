...
console.log(sum); // 15`} language="javascript" filename="javascript-1.js" />
...
<CodeSnippet code={`Array.reduce(function(total, currentValue, currentIndex, arr), initialValue)`} language="javascript" filename="javascript-2.js" />
...
<CodeSnippet code={`// Calculate total cost of items in a shopping cart
const shoppingCart = [
...
console.log(\`Total cost: $\${totalCost.toFixed(2)}\`); // Total cost: $1189.96`} language="javascript" filename="javascript-3.js" />
...
<CodeSnippet code={`// Count how many times each number appears
...
<CodeSnippet code={`const numbers = [1, 2, 2, 3, 3, 3, 4, 4, 5];`} language="javascript" filename="javascript-5.js" />

<br />

2. We initialize reduce with an empty object as our accumulator:
<CodeSnippet code={`const frequency = numbers.reduce((count, num) => {}, {});`} language="javascript" filename="javascript-6.js" />
...
<CodeSnippet code={`count[num] = (count[num] || 0) + 1;`} language="javascript" filename="javascript-7.js" />

<br />

Which is a shorter way of writing:
<CodeSnippet code={`if (count[num] === undefined) {
    count[num] = 1;
} else {
...
<CodeSnippet code={`// Flatten an array of arrays
const arrays = [[1, 2], [3, 4], [5, 6]];

const flattened = arrays.reduce((acc, curr) => acc.concat(curr), []);
console.log(flattened); // [1, 2, 3, 4, 5, 6]`} language="javascript" filename="javascript-9.js" />
...
<CodeSnippet code={`const arrays = [[1, 2], [3, 4], [5, 6]];`} language="javascript" filename="javascript-10.js" />

<br />

2. We initialize reduce with an empty array as our accumulator:
<CodeSnippet code={`const flattened = arrays.reduce((acc, curr) => acc.concat(curr), []);`} language="javascript" filename="javascript-11.js" />
...
<CodeSnippet code={`// Group objects by a property
const people = [
...
console.log(grouped);`} language="javascript" filename="javascript-12.js" />
...
2. We initialize reduce with an empty object as our accumulator:
<CodeSnippet code={`const grouped = people.reduce((acc, person) => {}, {});`} language="javascript" filename="javascript-13.js" />
...
<CodeSnippet code={`// Calculate the average of an array
const numbers = [1, 2, 3, 4, 5];

const average = numbers.reduce((sum, num) => sum + num, 0) / numbers.length;
console.log(average); // 3`} language="javascript" filename="javascript-14.js" />
...
<CodeSnippet code={`const numbers = [1, 2, 3, 4, 5];`} language="javascript" filename="javascript-15.js" />

<br />

2. We initialize reduce with an initial value of 0 as our accumulator:
<CodeSnippet code={`const average = numbers.reduce((sum, num) => sum + num, 0) / numbers.length;`} language="javascript" filename="javascript-16.js" />
