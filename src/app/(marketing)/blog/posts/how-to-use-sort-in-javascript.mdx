...
<CodeSnippet code={`const numbers = [5, 3, 8, 1, 2];
numbers.sort((a, b) => a - b);
console.log(numbers); // [1, 2, 3, 5, 8]`} language="javascript" filename="javascript-1.js" />
...
<CodeSnippet code={`Array.sort([compareFunction])`} language="javascript" filename="javascript-2.js" />
...
<CodeSnippet code={`Array.sort([compareFunction])`} language="javascript" filename="javascript-3.js" />
...
<CodeSnippet code={`// Sorting numbers in ascending order
const numbers = [5, 3, 8, 1, 2];
numbers.sort((a, b) => a - b);
console.log(numbers); // [1, 2, 3, 5, 8]`} language="javascript" filename="javascript-4.js" />
...
<CodeSnippet code={`// Sorting strings alphabetically
const fruits = ['banana', 'apple', 'cherry', 'date'];
fruits.sort();
console.log(fruits); // ['apple', 'banana', 'cherry', 'date']`} language="javascript" filename="javascript-5.js" />
...
<CodeSnippet code={`// Sorting objects by a property
const people = [
  { name: 'Alice', age: 25 },
  { name: 'Bob', age: 30 },
  { name: 'Charlie', age: 20 }
...
console.log(people);`} language="javascript" filename="javascript-6.js" />
