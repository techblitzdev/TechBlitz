...
<CodeSnippet language="javascript" content={`// Basic string splitting
...
<CodeSnippet language="javascript" content={`// Different ways to use split()
...
const fruits = text.split(/[;:,]/);  // ["apple", "banana", "orange", "grape"]`} />
...
<CodeSnippet language="javascript" content={`// Common split() patterns
...
const tagArray = tags.split(",");  // Creating tag arrays`} />
...
<CodeSnippet language="javascript" content={`// Basic split() usage
...
<CodeSnippet language="javascript" content={`// Advanced splitting with regex
const text = "apple;banana:orange,grape";
...
const values = data.split(/(::|--)/);  // Includes delimiters in result`} />
...
<br />
<CodeSnippet language="javascript" content={`// URL parsing
...
<br />
<CodeSnippet language="javascript" content={`// Safe string splitting
...
console.log(text.split("|"));  // ["no delimiter here"]`} />
...
<br />
<CodeSnippet language="javascript" content={`// Performance comparison
