...
<div className="text-center text-xs mt-2">
    Navigate your personalized learning journey with AI-driven recommendations.
</div>

<br />

<div className="mt-2">
Our advanced AI system analyzes your current skills and creates a tailored learning path just for you. Through sophisticated assessment algorithms, we identify your strengths and areas for improvement, ensuring every minute of your learning time is optimally spent.
</div>
