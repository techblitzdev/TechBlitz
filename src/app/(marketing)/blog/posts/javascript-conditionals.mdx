...
<CodeSnippet language="javascript" content={`if (condition) {
...
<br />
<CodeSnippet language="javascript" content={`// Example 1: Basic if statement
...
<br />
<CodeSnippet language="javascript" content={`// Be careful with truthy/falsy values
if (0) {
...
<CodeSnippet language="javascript" content={`// While this works:
...
<CodeSnippet language="javascript" content={`// Complex decision tree example
const score = 85;
...
<CodeSnippet language="javascript" content={`const dayOfWeek = "Monday";
...
// The switch statement checks the value of dayOfWeek against each case`} />
...
<CodeSnippet language="javascript" content={`// Equal to (==) - compares values
...
<CodeSnippet language="javascript" content={`// AND operator (&&) - both conditions must be true
const age = 25;
...
<CodeSnippet language="javascript" content={`function validateEmail(email) {
