...
<CodeSnippet language="javascript" content={`// Integer numbers
let age = 25;
let temperature = -10;
...
<CodeSnippet language="javascript" content={`// Different ways to create strings
...
<CodeSnippet language="javascript" content={`// Boolean values
let isActive = true;
...
<CodeSnippet language="javascript" content={`// Undefined - variable declared but not assigned
let userName;
...
<CodeSnippet language="javascript" content={`// Creating symbols
const id = Symbol('id');
...
<CodeSnippet language="javascript" content={`// Creating BigInts
...
<CodeSnippet language="javascript" content={`// Type checking
...
<CodeSnippet language="javascript" content={`// Best practices examples
// Type conversion
const userInput = "42";
