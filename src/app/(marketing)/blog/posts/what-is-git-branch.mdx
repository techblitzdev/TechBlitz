...
<CodeSnippet language="bash" content={`# View all branches
git branch
...
<CodeSnippet language="bash" content={`# List all branches
git branch
...
<CodeSnippet language="bash" content={`# Start a new feature
...
<CodeSnippet language="bash" content={`# Switch to main branch
git checkout main
...
<CodeSnippet language="bash" content={`# During a merge conflict
...
<CodeSnippet language="bash" content={`# Clean up old branches
