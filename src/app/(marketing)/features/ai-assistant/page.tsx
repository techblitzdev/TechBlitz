...
export async function generateMetadata() {
  const title = 'AI Coding Assistant | TechBlitz';
  const description =
...
export default function LeaderboardPage() {
  const jsonLd: WebPageJsonLd = {
    ...
    '@type': 'WebPage',
    url: `${getBaseUrl()}/features/ai-assistant`,
    headline: 'AI Coding Assistant | TechBlitz',
    description:
      'Get instant help with our AI tutor. Receive personalized questions, and guidance to accelerate your programming journey.',
    image:
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `${getBaseUrl()}/features/ai-assistant`,
    },
    keywords:
  ...
  return (
    <>
      ...
      <div className="container py-24">
        <h1 className="sr-only">AI Coding Assistant</h1>
