...
export default function Page() {
  ...
  return (
    <div className="container w-full min-h-screen flex justify-center items-center relative">
      ...
      <div className="mt-4 absolute bottom-5 text-center w-full flex flex-col items-center justify-center">
        <div className="flex items-center gap-5 justify-center">
          <Link
            href="https://www.tiktok.com/@techblitz.dev"
            className="size-5 fill-white hover:fill-accent duration-300"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
