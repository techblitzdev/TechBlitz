...
const CodeSnippet = dynamic(() => import('@/components/marketing/global/code-snippet'), {
  ssr: false,
});
    ...
    <LeftRightBlock
      left={
        <div className="flex flex-col gap-y-6 relative overflow-hidden">
          <Suspense fallback={<div className="min-h-[430px] w-full animate-pulse"></div>}>
            <CodeSnippet
              code={codeSnippet1}
              language="javascript"
      ...
      right={
        <div className="flex flex-col gap-y-6">
          ...
          <p className="text-white/70 max-w-xl text-base font-onest">
            ...
            grow from beginner to professional developer. Start your coding journey today with
            practical exercises that take just 5-10 minutes to complete.
          </p>
        </div>
      }
    />
