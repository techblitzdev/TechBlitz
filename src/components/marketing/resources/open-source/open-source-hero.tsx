...
export default function ResourceOpenSourceHeroBlock() {
  return (
    <section className="pt-32 lg:pt-52 pb-36 relative">
      <div className="mt-28 z-10 absolute inset-x-0 top-0 h-40 bg-linear-to-b from-[#000] to-transparent pointer-events-none"></div>
      ...
      <div className="flex flex-col gap-y-3 z-20 relative items-center">
        ...
        <div className="mt-2 flex gap-4">
          ...
          <Button
            ...
            className="text-black font-onest bg-linear-to-r! from-white! via-white/80! to-white! animate-shimmer bg-[length:200%_100%] transition-colors flex items-center gap-x-2"
          >
