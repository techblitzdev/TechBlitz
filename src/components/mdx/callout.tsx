  ...
  return (
      ...
      className={cn(
        'my-6 flex gap-4 rounded-lg border p-4',
        {
          ...
          'bg-red-200 border-red-300 text-red-900 dark:bg-red-950/90 dark:border-red-900 dark:text-red-200':
            type === 'error',
          'bg-purple-200 border-purple-300 text-purple-900 dark:bg-purple-950/90 dark:border-purple-900 dark:text-purple-200':
            type === 'top-tip',
        },
        className
      )}
    >
      ...
      <div className="flex-1 space-y-1.5">
        ...
        <div className="prose-sm prose-p:leading-relaxed prose-pre:p-0">{children}</div>
      </div>
    </div>
  );
}
