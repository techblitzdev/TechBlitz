...
export default async function BackToDashboard(opts: { href?: string; backTo?: string }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <Button href={href} variant="default" size="icon" wrapperClassName="flex items-center">
